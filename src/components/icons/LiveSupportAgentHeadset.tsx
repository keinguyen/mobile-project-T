...
const LiveSupportAgentHeadset = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    <G id="icon_24 / live support agent headset">
      <G id="icon_24 / live support agent headset_2">
        <Path
          id="Icon"
          fillRule="evenodd"
          clipRule="evenodd"
...
export default LiveSupportAgentHeadset;
