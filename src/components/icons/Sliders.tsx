...
const Sliders = (props: SvgProps) => (
  <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
    <G id="icon_24 / sliders">
      <G id="icon_24 / sliders_2">
        <G id="Icon">
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8 8C8 7.44772 8.44771 7 9 7H15C15.5523 7 16 7.44772 16 8C16 8.55228 15.5523 9 15 9H9C8.44771 9 8 8.55228 8 8Z"
            fill={props.color}
          />
          <Path
            fillRule="evenodd"
